#!/usr/bin/env python3
"""
Simple test script to verify the round_size method fix
"""
...
def round_size(asset: str, amount: float) -> float:
    ...
    return apply_precision_fix(clean_asset, amount)
...
def test_round_size_fix():
    ...
    for asset, amount, description in test_cases:
        ...
        try:
            ...
            fixed_amount = round_size(asset, amount)
    ...
    print("This should resolve the Binance API precision errors!")
